...
$(document).ready(function() {
    ...
    $("#addButton").click(function () {
        ...
        row_hrml += '<td><div class="input-group"><input type="text" name="product[]" id="product-' + counter + '" value="" class="form-control input-sm suggestions" maxlength="80"><span class="input-group-addon"><i class="fa fa-file-text-o pointer"></i></span></div><div class="details-con details-con-' + counter + '" style="display:none;"><textarea style="margin-top:5px;padding:5px 10px;height:60px;" class="form-control details" name="details[]" id="details-' + counter + '" maxlength="255"></textarea></div></td>';
        ...
        if (Site.Settings.default_tax_rate > 0) {
            ...
            row_hrml += '</select></td>';
            row_hrml += '<td><select class="tax_method form-control input-sm" style="min-width: 100px;" name="tax_method[]" id="tax_method-' + counter + '">' +
